            ...
            <div class="auth-box row">
                ...
                <div class="col-lg-5 col-md-7 bg-white">
                    <div class="p-3">
                        ...
                        <p class="text-center">Enter your pseudo and password to access admin page.</p>
                        <form class="mt-4" action="traitement.php"  id="myForm" method="get" >
                            <div class="row">
                                <div class="col-lg-12">
                                ...
                                <div class="col-lg-12 lien">
                                    <label class="text-dark" for="pwd"><a href="loginuser.php">Login for user</a></label>
                                </div>
