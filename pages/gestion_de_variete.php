                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>
                                    <?php for ($i=0; $i < count($liste); $i++) { ?>
                                        <tr>
                                            <th scope="row"><?php  echo $liste[$i]['id_variete'] ; ?></th>
                                            ...
                                            <td>
                                                <div class="form-actions">
                                                    ...
                                                    <button type="button" class="btn btn-dark"><a href="action.php?type=variete&action=update&id=<?php echo $liste[$i]['id_variete'] ; ?>">Edit </a> </button>
                                                </div>
                                            </td>
                                        </tr>
                                    <?php  }   ?>
